  ...
  Verification Tasks: Perform only the first of these (the hook coverage verification); do not perform any of the other tasks in this list, then created a detailed record of where we are leaving off for the next time we work on this. This record should include a full reference of what we found in the first item that we're working on. This should take the form of a new file you create in markdown with the suffix "-prompt-engineering-ref.md"
