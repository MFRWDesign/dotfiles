  ...
  2. Once you are done reading the script and thinking about it fully, second, read /Users/thomas.sample/.dotfiles/claude-code-docs/COMPLETE_PROMPT_ENGINEERING_DOCS.md (4407 lines) in 2 chunks:
  ...
  Verification Tasks: Perform only the fifth of these tasks (the System-Wide Feature Implementation Checklist); do not perform any of the other tasks in this list, then created a detailed record of where we are leaving off for the next time we work on this. This record should include a full reference of what we found in the item that we were just working on. This should take the form of a new file you create in markdown with the suffix "-prompt-engineering-ref.md" Before creating this file, you also need to read the following 4 files that were created in steps 1-4: 
  /Users/thomas.sample/.dotfiles/hook-coverage-verification-prompt-engineering-ref.md
  /Users/thomas.sample/.dotfiles/mcp-server-configuration-prompt-engineering-ref.md
  /Users/thomas.sample/.dotfiles/settings-json-compliance-prompt-engineering-ref.md
  /Users/thomas.sample/.dotfiles/slash-commands-completeness-check-prompt-engineering-ref.md

  1. Hook Coverage Verification
  - Verify ALL hook types documented in COMPLETE_PROMPT_ENGINEERING_DOCS.md are implemented for system-wide use.
  ...
  - Compare all slash commands in the enhanced script against examples in COMPLETE_PROMPT_ENGINEERING_DOCS.md
  ...
  - Verify all MCP servers documented in COMPLETE_PROMPT_ENGINEERING_DOCS.md are included as examples/templates
  ...
  - Ensure all settings fields from COMPLETE_PROMPT_ENGINEERING_DOCS.md are present in the system-wide configuration
  ...
  - Check that every system-wide feature mentioned in COMPLETE_PROMPT_ENGINEERING_DOCS.md has a corresponding implementation
